...
export const Route = createFileRoute('/_app/simple/queue')({
  component: GreetingQueue,
})

function GreetingQueue() {
  return (
...
function QueuePageInner() {
  const q = convexQuery(api.workflows.greeting.api.getGreetingWorkQueue, {})
          ...
          {workItems.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Create a new greeting to add tasks to the queue
              </p>
