...
/**
 * Test helper utilities for greeting workflow tests
 */
...
import {
  ...
  AUTH_GREETING_ROLES,
} from '../workflows/greeting/authSetup'
...
/**
 * Setup greeting authorization (roles and groups)
 */
export async function setupGreetingAuthorization(t: TestContext) {
  await t.mutation(
    internal.workflows.greeting.authSetup.setupAuthGreetingAuthorization,
    {},
  )
}

/**
 * Create and authenticate a user with greeting staff role
 */
export async function setupAuthenticatedGreetingUser(t: TestContext) {
