    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold">New Greeting</h1>
        </div>
      ...
      <div className="max-w-lg mx-auto">
        <div className="rounded-lg border bg-card p-6 space-y-4">
          <div>
            <h2 className="text-base font-medium">Create Greeting Workflow</h2>
            <p className="text-sm text-muted-foreground mt-1">
              A work item will be created for you to enter the greeting message.
            </p>
          </div>
          ...
          <div className="rounded-lg border bg-muted/30 p-4">
            ...
            <ol className="text-sm text-muted-foreground space-y-2">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>You can claim it and enter your greeting</span>
              </li>
            </ol>
          </div>
          ...
          {initializeMutation.isError && (
            <div className="rounded-lg border border-destructive/50 bg-destructive/10 p-3">
              <p className="text-sm text-destructive">
                Failed to create greeting. Please try again.
              </p>
            </div>
          )}
        </div>
